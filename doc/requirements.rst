...
===============================================
Requirements for scikit-surgeryspeech
===============================================

This is the software requirements file for scikit-surgeryspeech, part of the
SNAPPY project. The requirements listed below should define
what scikit-surgeryspeech does. Each requirement can be matched to a unit test that
